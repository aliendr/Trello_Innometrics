...
//	void save_long_str() {
//
//       Action action= new  Action("id", "String boardId", "String idMemberCreator", "String type", "String date", "1234567890123456789012345678901234567890");
//
//       action=actionRepository.save(action);
//
//       assertEquals(actionRepository.findById("id").get(), action);
//	}
